...
def render_tabs() -> None:
    ...
    with api_tab:
        ...
        st.button("Open summary", disabled=True)
        st.button("Show status", disabled=True)


def render_actions(form_data: dict) -> None:
